        ...
        <>
            <div className="container-fluid">
                ...
                <div className="col-lg-5 form-items d-flex align-items-center justify-content-center mt-3">
                    <h1 className="my-1 sign-In-Heading"><span>C</span>haapa.com</h1>
                    ...
                    <form action="" className="form mt-4 d-flex align-items-center justify-content-center">
                        <div class="form-floating mb-2">
                            <input type="text" className="form-control" id="floatingInput" placeholder='Full Name' autoComplete='off'/>
                            <label for="floatingInput">Full Name</label>
                        </div>

                        <div class="form-floating mb-2">
                            {/* <input type="text" className="form-control" id="floatingInput" autoComplete='off'/> */}
                            <select className='form-select mb-2' id='countryDropDown'>
                        ...
                        <div class="form-floating mb-2">
                            <input type="email" className="form-control" id="floatingInput" placeholder='Email address' autoComplete='off' />
